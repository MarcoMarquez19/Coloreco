...
/**
 * Códigos únicos de logros de dibujo
 */
export const LOGROS_DIBUJO = {
	NATURALEZA_EN_ESCENA_CABAÑA: 'NATURALEZA_EN_ESCENA_CABAÑA',
	BOSQUE_FRONDOSO_CABAÑA: 'BOSQUE_FRONDOSO_CABAÑA',
	NATURALEZA_EN_ESCENA_ARCOIRIS: 'NATURALEZA_EN_ESCENA_ARCOIRIS',
	GUARDIAN_DEL_CIELO_ARCOIRIS: 'GUARDIAN_DEL_CIELO_ARCOIRIS',
	ARTIFICIALIDAD_EN_ESCENA_ESTANQUE: 'ARTIFICIALIDAD_EN_ESCENA_ESTANQUE',
	VIDA_ACUATICA_ESTANQUE: 'VIDA_ACUATICA_ESTANQUE',
	ARTIFICIALIDAD_EN_ESCENA_CIUDAD: 'ARTIFICIALIDAD_EN_ESCENA_CIUDAD',
	TRAFICO_URBANO_CIUDAD: 'TRAFICO_URBANO_CIUDAD',
	ARTIFICIALIDAD_EN_ESCENA_SENDERO: 'ARTIFICIALIDAD_EN_ESCENA_SENDERO',
	SENDERO_VERDE: 'SENDERO_VERDE',
	ARTISTA_CABAÑA: 'ARTISTA_CABAÑA',
	ARTISTA_ARCOIRIS: 'ARTISTA_ARCOIRIS',
	ARTISTA_ESTANQUE: 'ARTISTA_ESTANQUE',
	ARTISTA_CIUDAD: 'ARTISTA_CIUDAD',
	ARTISTA_SENDERO: 'ARTISTA_SENDERO'
} as const;
...
export type CodigoLogro = 
	...
	| typeof LOGROS_DIBUJO[keyof typeof LOGROS_DIBUJO];
